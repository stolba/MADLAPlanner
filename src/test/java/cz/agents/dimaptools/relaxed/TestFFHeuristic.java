...
public class TestFFHeuristic extends AbstractDistributedAStarTest {
...
//		AStar search = new AStar(problem);
		...
		HeuristicInterface heuristic = new RelaxationHeuristic(world.getProblem(),new FFEvaluator(world.getProblem()));
