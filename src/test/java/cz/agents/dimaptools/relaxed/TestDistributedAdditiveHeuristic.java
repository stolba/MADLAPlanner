...
public class TestDistributedAdditiveHeuristic extends AbstractDistributedAStarTest {
...
//		AStar search = new AStar(problem);
		...
		DistributedRequestHeuristicInterface req = new RecursiveDistributedRelaxationRequestHeuristic(world, new AddEvaluator(world.getProblem()),1);
