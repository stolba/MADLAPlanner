...
public class TestRecursiveDistributedMaxHeuristic extends AbstractDistributedAStarTest {
...
//		AStar search = new AStar(problem);
		...
		DistributedRequestHeuristicInterface req = new RecursiveDistributedRelaxationRequestHeuristic(world, new MaxEvaluator(world.getProblem()));
		DistributedReplyHeuristicInterface rep = new RecursiveDistributedRelaxationReplyHeuristic(world, new MaxEvaluator(world.getProblem()),req.getRequestProtocol());
