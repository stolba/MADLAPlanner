...
public class TestAdditiveHeuristic extends AbstractDistributedAStarTest {
...
//		AStar search = new AStar(problem);
		...
		HeuristicInterface heuristic = new RelaxationHeuristic(world.getProblem(),new AddEvaluator(world.getProblem()));
