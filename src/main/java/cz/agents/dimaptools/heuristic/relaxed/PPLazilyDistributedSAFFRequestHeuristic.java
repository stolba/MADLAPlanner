...
public class PPLazilyDistributedSAFFRequestHeuristic extends RelaxationHeuristic implements DistributedRequestHeuristicInterface {
    ...
    public PPLazilyDistributedSAFFRequestHeuristic(DIMAPWorldInterface world) {
    	this(world,  Integer.MAX_VALUE);
    }

	public PPLazilyDistributedSAFFRequestHeuristic(DIMAPWorldInterface world,int maxRecursionDepth) {
		...
		LOGGER = Logger.getLogger(problem.agent + "." + PPLazilyDistributedSAFFRequestHeuristic.class);
	}
...
//		}
		...
		currentRequest.receiveReply(re.usedPublicActionIDs,null,re.heuristicValue);
