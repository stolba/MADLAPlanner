...
public class LazilyDistributedSAFFReplyHeuristic extends RelaxationHeuristic implements DistributedReplyHeuristicInterface {
	...
	public LazilyDistributedSAFFReplyHeuristic(DIMAPWorldInterface world) {
		...
		LOGGER = Logger.getLogger(problem.agent + "." + LazilyDistributedSAFFReplyHeuristic.class);
	}
	
	public LazilyDistributedSAFFReplyHeuristic(DIMAPWorldInterface world,DistributedHeuristicRequestProtocol requestProtocol) {
        this(world);
