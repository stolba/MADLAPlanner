...
public class ExactLPOCPGenerator implements CostPartitioningGeneratorInterface {
	...
	private final static Logger LOGGER = Logger.getLogger(ExactLPOCPGenerator.class);
	
	

	public ExactLPOCPGenerator(LPSolver solver, boolean free) {
		super();
		this.solver = solver;
		this.free = free;
	}
